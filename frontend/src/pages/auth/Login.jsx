  ...
  const handleGoogleSignIn = () => {
    ...
    window.google.accounts.id.prompt((notification) => {
      if (notification.isNotDisplayed() || notification.isSkippedMoment()) {
        // Fallback: render a real Google button in a hidden div and click it
        const container = document.getElementById('g_id_hidden_container');
        if (container) {
            ...
            <div>
              ...
              <div className="text-right mt-1.5">
                <button
                  ...
                  className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 text-xs font-medium transition-colors cursor-pointer"
                >
                  Forgot password?
                </button>
              </div>
