...
// load until it drains, rather than piling on more projects to persist.
 ...
 *                  backed up, and a snapshot of how many projects are live in
 ...
 * @param {{ docs: Map<string, unknown> }} [deps.documentManager]  - for active-project count
 */
export function createHealthRouter({ redisClient, getWorkers, persistQueue, documentManager }) {
  ...
  router.get('/ready', async (req, res) => {
    ...
    const activeProjects = documentManager ? documentManager.docs.size : null;
